<?php 
    ...
    <body style="background-color: #FF52A3">
		...
		<nav style="background:#FF52A3; padding-top:25px" class="navbar fixed-top navbar-expand-lg navbar-light">
				<div class="container-fluid">
					...
					>
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							<li class="nav-item">
								<a class="nav-link"  href="<?php echo site_url('/blog') ?>"><h3  style="color:#700045">Blog</h3></a>
							</li>
							<li class="nav-item">
...
<div class="snack-card">
			...
			<div class="row" style="margin-top: 50px;">
				<h2 style="font-weight: 800; color: #700045; font-size: 50px;">Related Recipes</h2>
			</div>
						...
						<div class="row" style="margin-bottom: 20px;">
								...
								<div class="row">
									<a href="<?php the_permalink(); ?>" style="text-decoration: none">
										<h1 style="font-weight: 700; color: #700045"><?php the_title(); ?></h1>
									</a>
								</div>
								<div class="row">
									<div class="col">
										<h4 style="color: #700045"><?php the_field('description'); ?></h4>
									</div>
							<div class="col">
