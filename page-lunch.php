<?php 
    get_header();?>
    <body style="background-color: #8B5B99">
		<div style="background-color: #8B5B99">
        ...
        <div class="container">
			<div class="row" style="margin-top: 30px">
				...
				<h1 style="color: #3B1349; font-weight: 700">Recipe of the Day:</h1>
            <?php 
...
<h2 style="color: #3B1349"><?php the_title(); ?></h2>
			</div>
			<div class="row">
				<div class="col-md-6">
					<h3 style="color: #3B1349"><?php the_field('ingredients_row_1') ?></h3>
                    <a href="<?php the_permalink(); ?>"><button type="button" style="margin-top: 25px; margin-bottom: 25px" class="Button-Primary-L-Lunch">View Recipe</button></a>
				</div>
                <div class="col-md-6">
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-md-3" style="align-items: start;">
                    <a href="<?php the_permalink(); ?>"><button class="Button-Primary-L-Lunch"> View Recipe</button></a>
                </div>
            </div>
            <hr>
              <?php  } get_footer();
